...
class PokemonSummaryScene
  ...
  def drawPageThree(pokemon)
    ...
    [pokename,46,62,0,base,shadow],
       [pokemon.level.to_s,46,92,0,Color.new(64,64,64),Color.new(176,176,176)],
       [_INTL("Objeto"),16,320,0,base,shadow],
       [_INTL("PS"),243,70,2,base,statshadows[0]],
       [sprintf("%d/%d",@pokemon.hp,@pokemon.totalhp),382,70,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.iv[0]),444,70,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.ev[0]),500,70,1,Color.new(64,64,64),Color.new(176,176,176)],
       [_INTL("Ataque"),225,114,0,base,statshadows[1]],
       [sprintf("%d",@pokemon.attack),382,114,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.iv[1]),444,114,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.ev[1]),500,114,1,Color.new(64,64,64),Color.new(176,176,176)],
       [_INTL("Defensa"),225,146,0,base,statshadows[2]],
       [sprintf("%d",@pokemon.defense),382,146,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.iv[2]),444,146,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.ev[2]),500,146,1,Color.new(64,64,64),Color.new(176,176,176)],
       [_INTL("Atk. Sp"),225,178,0,base,statshadows[3]],
       [sprintf("%d",@pokemon.spatk),382,178,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.iv[4]),444,178,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.ev[4]),500,178,1,Color.new(64,64,64),Color.new(176,176,176)],
       [_INTL("Def. Sp"),225,210,0,base,statshadows[4]],
       [sprintf("%d",@pokemon.spdef),382,210,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.iv[5]),444,210,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.ev[5]),500,210,1,Color.new(64,64,64),Color.new(176,176,176)],
       [_INTL("Veloc."),225,242,0,base,statshadows[5]],
       [sprintf("%d",@pokemon.speed),382,242,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.iv[3]),444,242,1,Color.new(64,64,64),Color.new(176,176,176)],
	   [sprintf("%d",@pokemon.ev[3]),500,242,1,Color.new(64,64,64),Color.new(176,176,176)],
    ...
    if pokemon.hp>0
      ...
      overlay.fill_rect(339,110,pokemon.hp*96/pokemon.totalhp,2,hpcolors[hpzone*2+1])
      overlay.fill_rect(339,112,pokemon.hp*96/pokemon.totalhp,4,hpcolors[hpzone*2])
    end
  end
