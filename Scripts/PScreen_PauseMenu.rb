...
class PokemonMenu
  ...
  def pbStartPokemonMenu
    ...
    commands[cmdEncounter = commands.length] = _INTL("Pokéradar") if $PokemonBag.pbQuantity(PBItems::POKERADAR2)>0
    ...
    cmdControls=-1
    commands[cmdControls=commands.length]=_INTL("Controles")
